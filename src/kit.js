...
import add          from './kit/add';
import after        from './kit/after';
...
import isLike       from './kit/isLike';
import isNot        from './kit/isNot';
import isNotLike    from './kit/isNotLike';
import join         from './kit/join';
import keys         from './kit/keys';
import last         from './kit/last';
import length       from './kit/length';
import log          from './kit/log';
import lowercase    from './kit/lowercase';
import lt           from './kit/lt';
import lte          from './kit/lte';
import max          from './kit/max';
import mean         from './kit/mean';
...
import pi           from './kit/pi';
import pow          from './kit/pow';
import prepend      from './kit/prepend';
...
import uppercase    from './kit/uppercase';
import urldecode    from './kit/urldecode';
import urlencode    from './kit/urlencode';
import values       from './kit/values';
