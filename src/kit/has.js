...
import { flatten, has as hasUtil } from '../util';

export default function hasHelper () {
	...
	return function has (...args) {
		if (args.length < 3) {
			throw new Error('Handlebars Helper "has" needs a minimum of 3 arguments');
		}
